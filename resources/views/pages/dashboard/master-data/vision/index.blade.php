...
@section('content')
            ...
            <div class="card my-0">
                <div
                    ...
                    <div class="d-flex align-items-center">
                        <a href="{{ route('dashboard.master-data.visions.create') }}"
    ...
    <div class="row">
        <div class="col">
            <div class="card my-0">
                <div class="card-body">
                    <form method="GET" action="{{ route('dashboard.master-data.visions.index') }}" id="filterForm">
                        <div
                        ...
                        <div class="row mb-3 g-2">
                            ...
                            {{-- Reset Buttons --}}
                            <div class="col-12 col-md-6">
                                <a href="{{ route('dashboard.master-data.visions.index') }}"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item d-flex align-items-center gap-2"
                                                        href="{{ route('dashboard.master-data.visions.show', $vision->id) }}">
                                                        <i class="ti ti-eye me-1"></i> View Details
                                                    </a>
                                                    <a class="dropdown-item d-flex align-items-center gap-2"
                                                        href="{{ route('dashboard.master-data.visions.edit', $vision->id) }}">
                                                        <i class="ti ti-pencil me-1"></i> Edit
                                                    </a>
                                                    <form id="form-delete-{{ $vision->id }}"
                                                        action="{{ route('dashboard.master-data.visions.destroy', $vision->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
