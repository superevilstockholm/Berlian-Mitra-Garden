            ...
            <div class="card my-0">
                <div
                    ...
                    <div class="d-flex align-items-center">
                        <a href="{{ route('dashboard.master-data.contacts.index') }}"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 fw-medium">{{ $contact->name ?? '-' }}</div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 fw-medium">{{ $contact->message ?? '-' }}</div>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card my-0">
                <div class="card-body">
                    ...
                    <a href="{{ route('dashboard.master-data.contacts.edit', $contact->id) }}"
                    ...
                    <form id="form-delete-{{ $contact->id }}"
                        action="{{ route('dashboard.master-data.contacts.destroy', $contact->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                    ...
                    <p class="text-muted small">
                        This page displays detailed information about the selected contact. To make changes, click the "Edit Contact" button.
                    </p>
                </div>
            </div>
        </div>
