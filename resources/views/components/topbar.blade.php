...
@endphp
<header class="pc-header" style="z-index: 1059;">
            ...
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item header-user-profile">
                    <a class="pc-head-link head-link-primary dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown"
                        ...
                        <img src="{{ auth()->user()?->avatar ?? asset('static/img/default-profile-picture.svg') }}" alt="user-image" class="user-avtar object-fit-cover" style="width: 34px; height: 34px;" />
                        <span>
