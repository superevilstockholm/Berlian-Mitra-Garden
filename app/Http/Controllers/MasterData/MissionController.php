...
class MissionController extends Controller
{
    ...
    public function index(IndexRequest $request): View
    {
        ...
        return view('pages.dashboard.master-data.mission.index', [
            'missions' => $missions,
        ]);
    }
    ...
    public function create(): View
    {
        ...
        return view('pages.dashboard.master-data.mission.create', [
    ...
    public function store(StoreRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('dashboard.master-data.missions.index')->with('success', 'Berhasil membuat misi.');
    }
    ...
    public function edit(Mission $mission): View
    {
        ...
        return view('pages.dashboard.master-data.mission.edit', [
            'mission' => $mission,
            'allowedMaxOrder' => $allowedMaxOrder,
        ]);
    }
    ...
    public function update(UpdateRequest $request, Mission $mission): RedirectResponse
    {
        ...
        return redirect()->route('dashboard.master-data.missions.index')->with('success', 'Berhasil memperbarui misi.');
    }
    ...
    public function destroy(Mission $mission): RedirectResponse
    {
        ...
        return redirect()->route('dashboard.master-data.missions.index')->with('success', 'Berhasil menghapus misi.');
    }
}
